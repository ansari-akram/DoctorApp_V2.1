...
def report_view(request):
    ...
    return render(request, 'report.html', {'confList': confList, 'newlist': newlist, 'value': value, 'patient_name': patient_name,
        ...
        if form.is_valid():
            ...
            for val in value:
                ...
                for img in image:
                    ...
                    import os
                cwd = "F:/Lab_Working_1/media/Patient_reports/"
                filename = cwd + img
                # 'E:\Lab_Working_1\media\Patient_reports\' + img
                output, label_value, confidence = detect_image_label(filename, url)
                ...
                AI_Usecase_Occurences.objects.create(time=datetime.now(), Image_Output_1=output[1], confidence=confidence)
